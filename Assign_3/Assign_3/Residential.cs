...
namespace Assign_3
{
    ...
    public class Apartment : Residential
    {
        ...
        public Apartment(uint id, uint x, uint y, uint o, string sa, string c, string st, string z, bool fs, uint p, uint bedroom, uint bath, uint sq, string u) : base(id, x, y, o, sa, c, st, z, fs, bedroom, bath, sq)
        {
            Unit = u;
        }
